                    ...
                    <section aria-labelledby="summary-heading" class="mt-16 bg-gray-50 rounded-lg px-4 py-6 sm:p-6 lg:p-8 lg:mt-0 lg:col-span-5">
                        ...
                        <div class="mt-6">
                            <form action="{{ route('orders.store') }}" method="POST" id="checkout-form">
                                @csrf
                                <button type="submit" 
                                        class="w-full bg-primary-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-primary-700 transition-all duration-300">
                                    Passer la commande
                                </button>
                            </form>
                        </div>
        ...
        @else
            <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                <div class="bg-white shadow-sm rounded-lg p-6 text-center">
                    <h2 class="text-xl font-semibold mb-4">Connexion requise</h2>
                    <p class="text-gray-600 mb-6">Veuillez vous connecter pour finaliser votre commande.</p>
                    <a href="{{ route('login') }}" 
